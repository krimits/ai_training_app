...
"""
    ...
    def _get_building_blocks(self):
        ...
        # Επιστρέφει το εκτενές κείμενο για τα δομικά στοιχεία
        # [Το περιεχόμενο θα ήταν πολύ μεγάλο για να το συμπεριλάβω εδώ ολόκληρο]
        return """[Εδώ θα μπει το πλήρες κείμενο για τα βασικά δομικά στοιχεία]"""
